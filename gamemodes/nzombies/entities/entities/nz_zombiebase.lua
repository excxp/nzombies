...
function ENT:Jump()
	local navarea = navmesh.GetNavArea(self:GetPos(), 50)
        if CurTime() < self:GetLastLand() + 0.5 or (IsValid(navarea) and navarea:HasAttributes(NAV_MESH_NO_JUMP)) then return end
